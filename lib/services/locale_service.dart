...
const Map<String, Map<String, String>> _i18n = {
  'de': {
    ...
    'close': 'Schließen',
    'holeInfo': 'Spieltipp anzeigen',
    'yourName': 'Dein Name',
    'yourNameHint': 'Einmal eingeben – wird dir künftig vorgeschlagen',
    'weatherClear': 'Sonnig',
  ...
  'en': {
    ...
    'close': 'Close',
    'holeInfo': 'Show playing tip',
    'yourName': 'Your name',
    'yourNameHint': "Enter once – you'll see it prefilled next time",
    'weatherClear': 'Sunny',
  ...
  'nl': {
    ...
    'close': 'Sluiten',
    'holeInfo': 'Speeltip tonen',
    'yourName': 'Jouw naam',
    'yourNameHint': 'Eén keer invoeren – wordt voortaan automatisch ingevuld',
    'weatherClear': 'Zonnig',
    'weatherPartlyCloudy': 'Licht bewolkt',
    'weatherCloudy': 'Bewolkt',
    'weatherFog': 'Mistig',
    'weatherDrizzle': 'Motregen',
    'weatherRain': 'Regen',
    'weatherSnow': 'Sneeuw',
    'weatherThunderstorm': 'Onweer',
    'send': 'Versturen',
